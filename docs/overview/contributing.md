...
git clone https://github.com/kalisio/kdk-ekosystem.git
cd kdk-ekosystem
...
> [!NOTE]
> **kdk-ekosystem** follows the [standardJS](https://standardjs.com/) style guide for linting and code consistency.
...
**kdk-ekosystem** follows the [Conventional commits specifications](https://www.conventionalcommits.org/en/v1.0.0-beta.3/)
...
kdk-ekosystem follows [Semantic Versioning](https://semver.org/) specification. Given a version number
...
Issues can be reported in the [issue tracker](https://github.com/kalisio/kdk-ekosystem/issues).
